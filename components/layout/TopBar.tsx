...
function TopBar() {
    ...
    return (
        <div className="sticky top-0 z-20 w-full flex justify-between items-center px-8 py-4 bg-blue-500 shadow-xl lg:hidden">
            <Image src="/logo.png" alt='logo' width={150} height={70} />

            <div className='flex gap-8 lg:flex hidden'>
                {navLinks.map((link) => (
